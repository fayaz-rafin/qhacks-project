    ...
    return (
        ...
        <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                ...
                <div className="mb-3 w-96 py-8 px-12">
                    <label
                        htmlFor="formFile"
                ...
                {showImage && <img src="https://images-ext-2.discordapp.net/external/Rp411oR4mpyjvVmIK3T3sVwvZ7Pb8CUNwgpCVzy9DjM/https/cs21003200207f14c17.blob.core.windows.net/receipts/1/a9481f14-f703-4dff-94fc-31cec02a23f8sample_receipt.jpeg?format=webp&width=372&height=1068" className="w-[48rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]" alt="receipt" />}
