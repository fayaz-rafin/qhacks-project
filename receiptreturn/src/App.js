            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                ...
                {showTable && (
                    <table className="table-auto py-4 px-2">
                        ...
                        <tbody>
                            <tr>
                                <td className="border px-4 py-2">Loblaws</td>
                                <td className="border px-4 py-2">Decemner 22, 2023</td>
                                <td className="border px-4 py-2">Lindt gold Bear</td>
                            ...
                            <tr>
                                <td className="border px-4 py-2">Loblaws</td>
                                <td className="border px-4 py-2">Decemner 22, 2023</td>
                                <td className="border px-4 py-2">PC Mint Herbal Tea * 2</td>
                                <td className="border px-4 py-2">No</td>
                            ...
                            <tr>
                                <td className="border px-4 py-2">Loblaws</td>
                                <td className="border px-4 py-2">Decemner 22, 2023</td>
                                <td className="border px-4 py-2">Cantelope</td>
                                <td className="border px-4 py-2 text-red-500">Yes</td>
                            </tr>
                            {/* More rows as needed */}
                        </tbody>
                    </table>
